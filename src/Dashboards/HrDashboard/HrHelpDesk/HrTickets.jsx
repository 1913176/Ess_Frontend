      ...
      try {
        ...
        const mappedTickets = tickets.map((ticket) => ({
          ...
          last_updated: ticket.last_updated.split("T")[0],
           ...
           name:ticket.supervisor_id ? ticket.supervisor_name || "N/A" :
                ticket.manager_id ? ticket.manager_name || "N/A" :
                ticket.employee_id ? ticket.employee_name || "N/A" :
                "N/A", // Updated to use appropriate name fields
          description: ticket.description || "No description provided.",
          service_type: ticket.service_type || "Others",
          category: ticket.supervisor_id ? "Supervisor" :
                    ticket.manager_id ? "Manager" :
                    ticket.employee_id ? "Employee" :
                    null ,
        }));
        ...
        setError("Failed to load tickets using HrTickets. Check the server or network.");
        setLoading(false);
      }
    };
                  ...
                  {filteredTickets.length === 0 ? (
                    ...
                    filteredTickets.map((ticket) => (
                      <TableRow key={ticket.id} className="hover:bg-gray-50">
                        ...
                        <TableCell>{ticket.name}</TableCell> {/* Updated to use 'name' field */}
                        <TableCell>
